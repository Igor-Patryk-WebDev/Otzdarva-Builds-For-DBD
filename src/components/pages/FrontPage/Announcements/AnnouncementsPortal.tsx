...
export const AnnouncementsPortal = ({ onClose }: Props) => {
  ...
  return (
    <div className="absolute top-5 right-2 w-120">
      <div
        className="flex flex-col gap-2 bg-neutral-800 rounded-lg p-8"
          ...
          return (
            ...
            >
              <div className="w-full">
                ...
                <p className="whitespace-break-spaces">{alert.desc}</p>
                <p className="text-neutral-600 text-right">{formatted}</p>
              </div>
            </div>
          );
        })}
