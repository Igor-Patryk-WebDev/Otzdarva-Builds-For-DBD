...
export const CharacterPortraitBlock = ({ name, portraitUrl, role }: CharacterPortraitBlockProps) => {
  ...
  return (
    <div className='relative aspect-500/625'>
      ...
      <img src="/images/CharPortrait_roleBG.webp" alt="" className={`absolute top-[50%] right-[50%] translate-x-[50%] translate-y-[-50%] z-2 scale-140 select-none pointer-events-none ${styles[role]}`} />
