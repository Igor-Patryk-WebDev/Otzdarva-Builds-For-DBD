...
export const BuildsList = ({ name, children }: BuildsListProps) => {
  ...
  return (
    <div className='absolute w-full max-w-400 max-h-dvh px-4 sm:px-8 pt-8 bottom-0 right-1/2 translate-x-1/2 z-1000 bg-[hsl(220_5%_8%)] border border-neutral-800 rounded-tl-2xl rounded-tr-2xl'>
      ...
      <div className='max-h-200 transition-all overflow-y-auto scrollbar-none scrollbar-thumb-otz mt-6'>
        <div className='grid grid-cols-[minmax(0,466px)] pb-32 lg:grid-cols-[repeat(2,minmax(0,466px))] 2xl:grid-cols-[repeat(3,minmax(0,466px))] justify-center gap-10 mx-auto'>
          {children}
        </div>
      </div>
    </div>
