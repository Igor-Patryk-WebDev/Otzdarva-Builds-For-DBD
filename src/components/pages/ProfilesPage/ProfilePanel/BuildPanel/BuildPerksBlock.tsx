...
const PerkDetails = ({ perk, visible, ...rest }: PerkDetailsProps) => {
  return (
    <div
      className={`absolute shadow-2xl shadow-black z-10000 w-150 bg-black ${visible ? "block" : "hidden"}`}
      style={{
        positionAnchor: "--perk",
        left: "anchor(right)",
        top: "anchor(top)",
    ...
    >
      ...
      <div
        className="bg-neutral-900 border border-t-0 border-neutral-800 p-4 text-sm"
